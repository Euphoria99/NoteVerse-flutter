...
import 'package:myfirstnotes/utilities/dialogs/loading_dialog.dart';
...
class _LoginViewState extends State<LoginView> {
  ...
  Widget build(BuildContext context) {
    //logic for loading when the user enters correct email and password.
      ...
      listener: (context, state) async {
        if (state is AuthStateLoggedOut) {
          if (state.exception is UserNotFoundAuthException) {
            ...
            await showErrorDialog(context, 'Please enter your credentials');
